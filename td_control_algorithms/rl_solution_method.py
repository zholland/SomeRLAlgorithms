...
import numpy as np
import gym.spaces
import tile_coding.tile_coding_action_value_function as tile_coding_function
    ...
    def factory(method_type, env, learning_rate, epsilon=0.0, epsilon_decay_factor=1.0, gamma=1.0, n=1, lambda_=0.0,
        ...
        if type(env.action_space) is gym.spaces.Discrete:
            ...
            action_value_function = \
                tile_coding_function.TileCodingActionValueFunction(env.observation_space.shape[0],
